...
object SampleData {
	...
	init {
		...
		val newDestination6 = Destination()
		newDestination6.id = 6
		newDestination6.city = "Abuja"
		newDestination6.description = "Abuja dummy decription"
		newDestination6.country = "Nigeria"
		DESTINATIONS.add(newDestination6)
